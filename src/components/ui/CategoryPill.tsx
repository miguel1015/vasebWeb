...
export default function CategoryPill({
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center w-full sm:w-auto px-3.5 py-3 sm:px-6 sm:py-3.5 md:h-17 md:w-40 font-sans text-sm sm:text-base md:text-lg font-medium tracking-wide transition-all ${
        isActive
